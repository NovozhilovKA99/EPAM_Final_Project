...
CREATE TABLE IF NOT EXISTS `mydb`.`Model` (
  ...
  INDEX `fk_Model_Type1_idx` (`Type_idType` ASC) VISIBLE,
...
-- Table `mydb`.`Сast`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Сast` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Transport_id` INT NOT NULL,
  `Route_id` INT NOT NULL,
  `User_idConduct` INT NOT NULL,
  ...
  INDEX `fk_cast_User1_idx` (`User_idConduct` ASC) VISIBLE,
  INDEX `fk_cast_User2_idx` (`User_idDriver` ASC) VISIBLE,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `idCast_UNIQUE` (`id` ASC) VISIBLE,
  UNIQUE INDEX `User_idUser_UNIQUE` (`User_idConduct` ASC) VISIBLE,
  UNIQUE INDEX `User_idUser1_UNIQUE` (`User_idDriver` ASC) VISIBLE,
